...
def home(request):
    ...
    if request.method == "POST":
        ...
        #api_request=requests.get('https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=' + zipcode + '&distance=5&API_KEY=6F61DED3-2C46-4249-9747-BF67BF76CCD0')
        api_request=requests.get('https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=' +zipcode+ '&distance=25&API_KEY=6F61DED3-2C46-4249-9747-BF67BF76CCD0')
        ...
        api_request=requests.get('https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=10001&distance=25&API_KEY=6F61DED3-2C46-4249-9747-BF67BF76CCD0')
